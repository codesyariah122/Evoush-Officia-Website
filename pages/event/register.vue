<template>
	<div>
			...
			<div class="row justify-content-center mt-5">
				...
				<div class="row justify-content-end mt-3 mb-3">
					<div class="col-lg-12 col-xs-6 col-sm-6">
						<nuxt-link class="btn btn-danger ml-3 mt-3" to="/#home"><i class='bx bx-arrow-back'></i>Kembali</nuxt-link>
					</div>
				</div> -->
      ...
      <div class="flex-w flex-col-sb wsize1 bg0 p-l-70 p-t-37 p-b-52 p-r-50 respon1">
        ...
        <div class="w-full p-t-100 p-b-90 p-l-48 p-l-0-md">
          ...
          <p class="m2-txt1 p-b-46">
            Halo evousher, memeriahkan hari jadi evoush yang pertama, kita akan mengadakan event yang di isi beberapa perlombaan yang menarik tentunya juga dengan hadiah yang menarik, mau ikutan lombanya, ayo daftarkan diri kalian sekarang.
          </p>
      ...
      <div class="wsize2 bg-img1 respon2" style="background-image: url('https://raw.githubusercontent.com/evoush12/bahan_evoush/main/event/anniversary3.jpeg');">
      </div>
    </div>
...
<script>
	...
	export default {
		components: {FormEvent, SocialSharing, Logo},
		layout: 'anniversary',
