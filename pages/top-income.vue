						...
						<div class="col-md-12 col-xs-12 col-sm-12 mt-3 mb-5">
							<div class="card profile-card-2">
								<div class="card-img-block">
									<img class="img-responsive img-fluid" src='https://mediatrack.sg/wp-content/uploads/2021/02/digital-transformation-banner-blog.png' alt="Card image cap">
								</div>
								<div class="card-body pt-5">
									<div class="row justify-content-center">
										<img src="https://raw.githubusercontent.com/codesyariah122/bahan-evoush/main/images/profile/default.jpg" alt="profile-image" class="profile img-fluid img-responsive image--profile-member img-responsive rounded-circle center-block d-block mx-auto mt-2"/>
									</div>

									<div class="row justify-content-center mt-5 media-body">
										<div class="col-lg-8 col-xs-8 col-sm-8">
											<center>											
												<h5 class="card-title ml-3">Member Name</h5>
												<p><strong>Username : member.username</strong></p>
												<p class="badge badge-primary text-white"> achievement </p>
