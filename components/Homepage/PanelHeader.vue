				...
				<div class="panel panel-default panel-header" style="margin-top: -5rem;">
					<div class="panel-body panel-body-header">
						<div class="row">
							...
							<div class="col-md-6">
								<h2 class="ml-1" v-html="panel.context.header"> </h2>
...
<script>
	import ImgPanelSatu from '~/assets/images/animated/anim31.gif'
				...
				panels: [
					{
						id:1,
						context: {
							header: `Buat Rencana Besar Bersama <span style="font-family: 'Walkway'; color: #ff3b40;">Evoush</span>`,
