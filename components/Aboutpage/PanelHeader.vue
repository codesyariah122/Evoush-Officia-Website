				...
				<div class="panel panel-default panel-header" style="margin-top: -5rem;">
					<div class="panel-body panel-body-header">
						<div class="row">
							...
							<div class="col-md-6">
								<h2 style="font-family: Walkway;" class="ml-1" v-html="panel.context.header"> </h2>
								<p class="mt-3" v-html="panel.context.paragraph"></p>
							</div>
						</div>
					</div>
				</div>
...
<script>
	import ImgPanelSatu from '~/assets/images/kantor/Masuk.jpg'
				...
				panels: [
					{
						...
						context: {
							...
							paragraph: `Di Tempat inilah kami awali semangat untuk membangun bisnis masa depan anda yang <span style="font-family: Reey Regular;">Cemerlang</span> hanya bersama <b style="color: #ff3b40;"><u></u>Evoush</b>. Bangun kejayaan bisnis anda dengan penuh semangat <i class="fas fa-tags text-info"></i> tuntun strategy anda bersama team anda satukan semua gagasan menjadi sebuah gugusan yang meleburkan energy menjadi satu cahaya besar.`
						},
						vector: {
							first: ImgPanelSatu
						}
