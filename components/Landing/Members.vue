					...
					<div v-for="member in members.data" class="col-lg-4 col-md-6 d-flex align-items-stretch mb-3" data-aos="zoom-in" data-aos-delay="100">
						<div :class="(member.id % 2 == 0) ? 'icon-box iconbox-blue' : 'icon-box iconbox-red'">
							<div class="icon">
								...
								<img v-if="member.avatar" :src="`https://raw.githubusercontent.com/evoush-products/bahan_evoush/master/migration_db/${member.avatar}`" class="img-fluid img-responsive image--profile-member img-responsive rounded-circle center-block d-block mx-auto mt-2" width="150">
