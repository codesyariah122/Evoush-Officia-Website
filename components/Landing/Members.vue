			...
			<div class="container" data-aos="fade-up">
				<div class="section-title">
					...
					<p>
						...
						Berikut ini adalah list member <span style="color:#ff3b40;">evoush</span> yang telah terdaftar resmi di system web replika <span style="color:#ff3b40;">evoush</span>. <br> Ini merupakan bagian web support kami guna meningkatkan branding secara personal bagi member-member evoush, dan kami akan selalu terus meningkatkan kualitas fungsi dari web replika kami.
					</p>
				</div>
				...
				<div class="row">
					...
					<div v-for="member in members.data" class="col-lg-4 col-md-6 d-flex align-items-stretch mb-3" data-aos="zoom-in" data-aos-delay="100">
						<div :class="(member.id % 2 == 0) ? 'icon-box iconbox-blue' : 'icon-box iconbox-pink'">
							<div class="icon">
								...
								<img v-if="member.avatar" :src="`https://app.evoush.com/storage/${member.avatar}`" class="img-fluid img-responsive" width="150">
