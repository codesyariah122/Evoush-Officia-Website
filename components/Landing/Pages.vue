		...
		<section id="pages" class="pages">
			<div class="container" data-aos="fade-up">
				<div class="section-title">
					<h2>Pages</h2>
					<p>
						Lebih lanjut tentang evoush yang bisa anda akses melalui beberapa daftar halaman di bawah.
					</p>
				</div>
			...
			<h4><a href="">Founder</a></h4>
			<p>
				Geliat bisnis di evoush semakin pesat dengan semangat perintis yang memberi semangat kepada teman-teman member lainnya, dalam meraih pencapian terbaik dalam berbisnis di evoush. Berikut ini daftar founder evoush yang telah kami dokumentasikan menjadi sebuah momen pencapaian dalam meraih hasil terbaik bersama evoush.
			</p>
			<nuxt-link to="/founder" class="btn btn-primary mt-3">Founder evoush</nuxt-link>
		</div>
	</div>
...
<h4><a href="">Gallery & Testimoni</a></h4>
<p>
	Dokumentasi evoush berupa gallery, testimoni picture, testimoni video khasiat product-product evoush, materi-materi dokumentasi mengenai pencapaian member-member evoush dalam lingkup bisnis evoush.
</p>
<nuxt-link to="/gallery" class="btn btn-primary mt-3">Lihat Gallery</nuxt-link>
</div>
</div>
