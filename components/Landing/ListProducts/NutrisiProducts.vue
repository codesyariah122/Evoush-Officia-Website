<template>
	<div>
		...
		data-aos-delay="200"
		>
		<div v-for="product in nutritions.slice().reverse()" :class="`${product.categories.map(d => d.name === 'Nutrisi' ? 'col-lg-4 portfolio-item filter-nutrisi' : 'col-lg-4 portfolio-item filter-kosmetik')}`">
